...
namespace StraniVari.Database.Migrations
{
    ...
    [Migration("20221120145718_addingSchoolMaterialsTable")]
    partial class addingSchoolMaterialsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StraniVari.Core.Entities.Material", b =>
                {
                    ...
                    b.Property<int?>("SchoolMaterialId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("SchoolMaterialId");
            ...
            modelBuilder.Entity("StraniVari.Core.Entities.Material", b =>
                {
                    b.HasOne("StraniVari.Core.Entities.SchoolMaterial", null)
                        .WithMany("Materials")
                        .HasForeignKey("SchoolMaterialId");
                });
