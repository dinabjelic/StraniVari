...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // appBar: AppBar(
      //     title: Text("StraniVari"),
      //     backgroundColor: Color.fromARGB(255, 222, 210, 210)),
              ...
              child: Stack(children: [
                Positioned(
                  ...
                  child: Center(
                      child: Text(
                    "STRANI VARI",
                      style: TextStyle(color: Colors.black, fontSize: 20, fontFamily: 'NothingYouCouldDo-Regular', fontWeight: FontWeight.bold),
                  )),
                ),
                Padding(
                  ...
                  child: Column(children: [
                    Container(
                      ...
                      child: TextField(
                        decoration: InputDecoration(border:InputBorder.none, hintText: "Username",hintStyle: TextStyle(fontSize: 10, color: Colors.grey))
                      ),
                    ),
                    Container(
                      padding: EdgeInsets.symmetric(horizontal:10),
                      ...
                      child: TextField(
                        decoration:  InputDecoration(border: InputBorder.none,  hintText: "Password", hintStyle:TextStyle(fontSize: 10, color: Colors.grey)),
                      ),
                    ),
                    Container(
                      height: 40,
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(colors: [Color.fromARGB(255, 220, 170, 157), Color.fromARGB(255, 217, 215, 208)])
                      ),
                      child: InkWell(
                        onTap: (){
